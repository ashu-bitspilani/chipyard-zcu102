...
set ::program::boards::spec [dict create \
	...
	zcu106          [dict create  iface spix8   size 128  bitaddr 0x0        memdev {mt25qu512a-spi-x1_x2_x4_x8}]]
	zcu102          [dict create  iface spix8   size 128  bitaddr 0x0        memdev {mt25qu512a-spi-x1_x2_x4_x8} ]]
